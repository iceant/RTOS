...
////////////////////////////////////////////////////////////////////////////////
////
static dev_i2c_t * DS1307__device;
static os_mutex_t DS1307__lock;
/**
 * @brief Initializes the DS1307 module. Sets clock halt bit to 0 to start timing.
 * @param hi2c User I2C handle pointer.
 */
void DS1307_Init(dev_i2c_t * device) {
    DS1307__device = device;
    os_mutex_init(&DS1307__lock, "DS307_Lock", OS_QUEUE_PRIO);
...
void DS1307_SetRegByte(uint8_t regAddr, uint8_t val) {
    ...
    os_mutex_lock(&DS1307__lock);
    DS1307__device->send(DS1307_I2C_ADDR<<1, bytes, 2);
    os_mutex_unlock(&DS1307__lock);
}
...
uint8_t DS1307_GetRegByte(uint8_t regAddr) {
    ...
    int ret;
    os_mutex_lock(&DS1307__lock);
    ret = DS1307__device->send(DS1307_I2C_ADDR<<1, &regAddr, 1);
