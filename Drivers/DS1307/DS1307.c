...
void DS1307_SetRegByte(uint8_t regAddr, uint8_t val) {
    ...
    drv_i2c_write(DS1307__device, DS1307_I2C_ADDR<<1, bytes, 2, I2C_LONG_TIMEOUT);
}
...
uint8_t DS1307_GetRegByte(uint8_t regAddr) {
    uint8_t val=0;
    int ret = drv_i2c_write(DS1307__device, DS1307_I2C_ADDR<<1, &regAddr, 1, I2C_LONG_TIMEOUT);
    ret = drv_i2c_read(DS1307__device, DS1307_I2C_ADDR<<1, &val, 1, I2C_LONG_TIMEOUT);
    return val;
}
