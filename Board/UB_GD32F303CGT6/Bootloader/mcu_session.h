...
#define MCU_SESSION_STATE_WAIT_FOR_FW_DATA  0x1000
#define MCU_SESSION_STATE_RECV_FW_DATA      0x1001
...
typedef int (*mcu_session_rx_handler)(mcu_session_t * session, void* data, int data_size, void* userdata);
