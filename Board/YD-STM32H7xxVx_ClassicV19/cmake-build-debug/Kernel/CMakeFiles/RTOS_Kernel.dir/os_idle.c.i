...
os_err_t os_idle_init(void){
    os_thread_init(&os_idle__task, "idle", os_idle_thread, 0, os_idle__task_stack, sizeof(os_idle__task_stack), 32 -1, 5);
