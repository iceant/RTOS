# 0 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c"
# 1 "D:\\RTOS\\Board\\YD-STM32H7xxVx_ClassicV19\\cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c"
...
# 2 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c" 2
...
# 4 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c" 2




# 7 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c"
...
static void BootThreadEntry(void* p){
    ...
    BSP_USART1_Printf("worker1 ready! \r\n");
    ...
    BSP_USART1_Printf("worker2 ready! \r\n");

    int nCount = 0;
    while(1){
        BSP_USART1_Printf("[Boot] count=%d tick:%"
# 61 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c" 3 4
                                      "l" 
# 61 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/main.c"
...
int main(void){
    Board_Init();
    BSP_USART1_Printf("SystemCoreClock: %d\r\n", SystemCoreClock);
    BSP_USART1_Printf("HAL_RCC_GetPCLK1Freq: %d\r\n", HAL_RCC_GetPCLK1Freq());
    ...
    BSP_USART1_Printf("kernel startup: %d\r\n", err);
