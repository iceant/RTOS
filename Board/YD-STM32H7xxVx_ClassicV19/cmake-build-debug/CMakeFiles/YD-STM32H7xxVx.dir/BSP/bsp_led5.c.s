...
.Ltext0:
	...
	.file 1 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/BSP/bsp_led5.c"
	.section	.text.BSP_LED5_Init,"ax",%progbits
	.align	1
	.global	BSP_LED5_Init
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED5_Init, %function
BSP_LED5_Init:
.LFB335:
	.loc 1 14 1
	.cfi_startproc
...
.LBB2:
	.loc 1 16 10
	.loc 1 16 36
	.loc 1 16 100 is_stmt 0
	ldr	r3, .L3
	ldr	r2, [r3, #224]
	.loc 1 16 111
	orr	r2, r2, #2
	str	r2, [r3, #224]
	.loc 1 16 134 is_stmt 1
	.loc 1 16 207 is_stmt 0
	ldr	r3, [r3, #224]
	.loc 1 16 218
	and	r3, r3, #2
	.loc 1 16 141
	str	r3, [sp]
	.loc 1 16 240 is_stmt 1
	.loc 1 16 241 is_stmt 0
	ldr	r3, [sp]
.LBE2:
...
.L3:
	...
	.cfi_endproc
.LFE335:
	.size	BSP_LED5_Init, .-BSP_LED5_Init
	.section	.text.BSP_LED5_On,"ax",%progbits
	.align	1
	.global	BSP_LED5_On
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED5_On, %function
BSP_LED5_On:
.LFB336:
...
.L7:
	...
	.cfi_endproc
.LFE336:
	.size	BSP_LED5_On, .-BSP_LED5_On
	.section	.text.BSP_LED5_Off,"ax",%progbits
	.align	1
	.global	BSP_LED5_Off
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED5_Off, %function
BSP_LED5_Off:
.LFB337:
...
.L11:
	...
	.cfi_endproc
.LFE337:
	.size	BSP_LED5_Off, .-BSP_LED5_Off
	.section	.text.BSP_LED5_Toggle,"ax",%progbits
	.align	1
	.global	BSP_LED5_Toggle
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED5_Toggle, %function
BSP_LED5_Toggle:
.LFB338:
...
.L15:
	...
	.cfi_endproc
.LFE338:
	.size	BSP_LED5_Toggle, .-BSP_LED5_Toggle
	.text
.Letext0:
