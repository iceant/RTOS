...
.Ltext0:
	...
	.file 1 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/BSP/bsp_led3.c"
	.section	.text.BSP_LED3_Init,"ax",%progbits
	.align	1
	.global	BSP_LED3_Init
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED3_Init, %function
BSP_LED3_Init:
.LFB335:
	.loc 1 12 1
	.cfi_startproc
...
.LBB2:
	.loc 1 14 10
	.loc 1 14 36
	.loc 1 14 100 is_stmt 0
	ldr	r3, .L3
	ldr	r2, [r3, #224]
	.loc 1 14 111
	orr	r2, r2, #1
	str	r2, [r3, #224]
	.loc 1 14 134 is_stmt 1
	.loc 1 14 207 is_stmt 0
	ldr	r3, [r3, #224]
	.loc 1 14 218
	and	r3, r3, #1
	.loc 1 14 141
	str	r3, [sp]
	.loc 1 14 240 is_stmt 1
	.loc 1 14 241 is_stmt 0
	ldr	r3, [sp]
.LBE2:
	.loc 1 14 8 is_stmt 1
	.loc 1 16 5
	.loc 1 16 28 is_stmt 0
	mov	r3, #16384
	str	r3, [sp, #4]
	.loc 1 17 5 is_stmt 1
	.loc 1 17 29 is_stmt 0
	movs	r3, #1
	str	r3, [sp, #8]
...
.L3:
	...
	.cfi_endproc
.LFE335:
	.size	BSP_LED3_Init, .-BSP_LED3_Init
	.section	.text.BSP_LED3_On,"ax",%progbits
	.align	1
	.global	BSP_LED3_On
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED3_On, %function
BSP_LED3_On:
.LFB336:
...
.L7:
	...
	.cfi_endproc
.LFE336:
	.size	BSP_LED3_On, .-BSP_LED3_On
	.section	.text.BSP_LED3_Off,"ax",%progbits
	.align	1
	.global	BSP_LED3_Off
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED3_Off, %function
BSP_LED3_Off:
.LFB337:
	.loc 1 28 24 is_stmt 1
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	push	{r3, lr}
...
.L11:
	...
	.cfi_endproc
.LFE337:
	.size	BSP_LED3_Off, .-BSP_LED3_Off
	.section	.text.BSP_LED3_Toggle,"ax",%progbits
	.align	1
	.global	BSP_LED3_Toggle
	.syntax unified
	.thumb
	.thumb_func
	.type	BSP_LED3_Toggle, %function
BSP_LED3_Toggle:
.LFB338:
...
.L15:
	...
	.cfi_endproc
.LFE338:
	.size	BSP_LED3_Toggle, .-BSP_LED3_Toggle
	.text
.Letext0:
