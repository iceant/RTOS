# 0 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c"
# 1 "D:\\RTOS\\Board\\YD-STM32H7xxVx_ClassicV19\\cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c"
# 51 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c"
...
# 52 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c" 2
# 101 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c"
HAL_StatusTypeDef DelayBlock_Enable(DLYB_TypeDef *DLYBx)
{
  uint32_t unit = 0U;
  uint32_t sel = 0U;
  ...
  DLYBx->CR = (0x1UL << (0U)) | (0x1UL << (1U));

  for (sel_current = 0U; sel_current < ((uint32_t)0x0000000CU); sel_current++)
  {

    lng_mask = (0x001UL << (16U)) << sel_current;
    tuning = 0U;
    for (unit_current = 0U; unit_current < ((uint32_t)0x00000080U); unit_current++)
    {

      DLYBx->CFGR = ((uint32_t)0x0000000CU) | (unit_current << (8U));


      tickstart = HAL_GetTick();
      while ((DLYBx->CFGR & (0x1UL << (31U))) == 0U)
      {
        if((HAL_GetTick() - tickstart) >= 0xFFU)
        {
          return HAL_TIMEOUT;
        }
      }
...
# 185 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_ll_delayblock.c"
HAL_StatusTypeDef DelayBlock_Configure(DLYB_TypeDef *DLYBx,uint32_t PhaseSel, uint32_t Units )
{
