# 0 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
# 1 "D:\\RTOS\\Board\\YD-STM32H7xxVx_ClassicV19\\cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
# 107 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
...
# 108 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c" 2
# 198 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
static uint32_t uwNORMemoryDataWidth = ((uint8_t)0x00);
# 233 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Init(NOR_HandleTypeDef *hnor, FMC_NORSRAM_TimingTypeDef *Timing,
                               FMC_NORSRAM_TimingTypeDef *ExtTiming)
{
  ...
  if (hnor == 
# 240 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c" 3 4
             ((void *)0)
# 240 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 260 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
  ...
  (((FMC_Bank1_TypeDef *) ((((0x40000000UL) + 0x12000000UL) + 0x4000UL) + 0x0000UL))->BTCR[0] |= (0x1UL << (31U)));
  ...
  if (hnor->Init.WriteOperation == (0x00000000U))
  {
  ...
  else
  {
    ...
    if (uwNORMemoryDataWidth == ((uint8_t)0x00))
    {
      do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x00AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x00AA))))))) = ((uint16_t)0x0098)); __DSB(); } while(0)
                                 ;
    }
    else
    {
      do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0055)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0055))))))) = ((uint16_t)0x0098)); __DSB(); } while(0);
    }

    hnor->CommandSet = *(volatile uint16_t *) ((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0013)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0013)))));
...
HAL_StatusTypeDef HAL_NOR_DeInit(NOR_HandleTypeDef *hnor)
{
# 357 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
...
# 411 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
...
# 447 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Read_ID(NOR_HandleTypeDef *hnor, NOR_IDTypeDef *pNOR_ID)
{
  uint32_t deviceaddress;
  ...
  else if (state == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      if (uwNORMemoryDataWidth == ((uint8_t)0x00))
      {
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0AAA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0AAA))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0)
                                     ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0AAA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0AAA))))))) = ((uint16_t)0x0090)); __DSB(); } while(0)
                                           ;
      }
      else
      {
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0090)); __DSB(); } while(0)
                                           ;
      }
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {
      do{ (*(volatile uint16_t *)((uint32_t)(deviceaddress)) = ((uint16_t)0x0090)); __DSB(); } while(0);
    }
    else
    {
...
HAL_StatusTypeDef HAL_NOR_ReturnToReadMode(NOR_HandleTypeDef *hnor)
{
  ...
  else if (state == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      do{ (*(volatile uint16_t *)((uint32_t)(deviceaddress)) = ((uint16_t)0x00F0)); __DSB(); } while(0);
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {
      do{ (*(volatile uint16_t *)((uint32_t)(deviceaddress)) = ((uint16_t)0x00FF)); __DSB(); } while(0);
    }
    else
    {
...
# 629 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Read(NOR_HandleTypeDef *hnor, uint32_t *pAddress, uint16_t *pData)
{
  uint32_t deviceaddress;
  HAL_NOR_StateTypeDef state;
  ...
  else if (state == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      if (uwNORMemoryDataWidth == ((uint8_t)0x00))
      {
        ...
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0AAA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0AAA))))))) = ((uint16_t)0x00F0)); __DSB(); } while(0)
                                          ;
      }
      else
      {
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00F0)); __DSB(); } while(0)
                                          ;
      }
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {
      do{ (*(volatile uint16_t *)((uint32_t)(pAddress)) = ((uint16_t)0x00FF)); __DSB(); } while(0);
    }
    else
    {
    ...
    if (status != HAL_ERROR)
    {
      ...
      *pData = (uint16_t)(*(volatile uint32_t *)pAddress);
    }
...
# 729 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Program(NOR_HandleTypeDef *hnor, uint32_t *pAddress, uint16_t *pData)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  else if (hnor->State == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      if (uwNORMemoryDataWidth == ((uint8_t)0x00))
      {
        ...
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0AAA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0AAA))))))) = ((uint16_t)0x00A0)); __DSB(); } while(0)
                                       ;
      }
      else
      {
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00A0)); __DSB(); } while(0);
      }
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {
      do{ (*(volatile uint16_t *)((uint32_t)(pAddress)) = ((uint16_t)0x0040)); __DSB(); } while(0);
    }
    else
    {
    ...
    if (status != HAL_ERROR)
    {
      ...
      do{ (*(volatile uint16_t *)((uint32_t)(pAddress)) = (*pData)); __DSB(); } while(0);
    }
...
# 823 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_ReadBuffer(NOR_HandleTypeDef *hnor, uint32_t uwAddress, uint16_t *pData,
                                     uint32_t uwBufferSize)
{
  uint32_t deviceaddress;
...
# 934 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_ProgramBuffer(NOR_HandleTypeDef *hnor, uint32_t uwAddress, uint16_t *pData,
                                        uint32_t uwBufferSize)
{
  ...
  else if (hnor->State == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      ...
      do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint8_t)0x25)); __DSB(); } while(0);
      do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint16_t)(uwBufferSize - 1U))); __DSB(); } while(0);
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {

      do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint16_t)0x00E8)); __DSB(); } while(0);
      do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint16_t)(uwBufferSize - 1U))); __DSB(); } while(0);
    }
    else
    {
    ...
    if (status != HAL_ERROR)
    {
      ...
      {
        do{ (*(volatile uint16_t *)((uint32_t)(p_currentaddress)) = (*data)); __DSB(); } while(0);
      ...
      if (hnor->CommandSet == (uint16_t)0x0002)
      {
        do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint8_t)0x29)); __DSB(); } while(0);
      }
      else
      {
        do{ (*(volatile uint16_t *)((uint32_t)((deviceaddress + uwAddress))) = ((uint16_t)0x00D0)); __DSB(); } while(0);
      }
    }
...
# 1054 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Erase_Block(NOR_HandleTypeDef *hnor, uint32_t BlockAddress, uint32_t Address)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  else if (hnor->State == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      if (uwNORMemoryDataWidth == ((uint8_t)0x00))
      {
        ...
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0AAA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0AAA))))))) = ((uint16_t)0x0080)); __DSB(); } while(0)
                                                      ;
      }
      else
      {
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0);
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0080)); __DSB(); } while(0)
                                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x00AA)); __DSB(); } while(0)
                                                       ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
      ...
      do{ (*(volatile uint16_t *)((uint32_t)((uint32_t)(BlockAddress + Address))) = ((uint8_t)0x30)); __DSB(); } while(0);
    }
    else if (hnor->CommandSet == (uint16_t)0x0001)
    {
      do{ (*(volatile uint16_t *)((uint32_t)((BlockAddress + Address))) = ((uint16_t)0x0060)); __DSB(); } while(0);
      do{ (*(volatile uint16_t *)((uint32_t)((BlockAddress + Address))) = ((uint16_t)0x00D0)); __DSB(); } while(0);
      do{ (*(volatile uint16_t *)((uint32_t)((BlockAddress + Address))) = ((uint16_t)0x0020)); __DSB(); } while(0);
      do{ (*(volatile uint16_t *)((uint32_t)((BlockAddress + Address))) = ((uint16_t)0x00D0)); __DSB(); } while(0);
    }
    else
    {
...
# 1150 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Erase_Chip(NOR_HandleTypeDef *hnor, uint32_t Address)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  else if (hnor->State == HAL_NOR_STATE_READY)
  {
    ...
    if (hnor->CommandSet == (uint16_t)0x0002)
    {
      ...
      else
      {
        ...
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x02AA)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x02AA))))))) = ((uint16_t)0x0055)); __DSB(); } while(0)
                                                      ;
        do{ (*(volatile uint16_t *)((uint32_t)(((uint32_t)(((uwNORMemoryDataWidth) == ((uint8_t)0x01))? ((uint32_t)((deviceaddress) + (2U * ((uint16_t)0x0555)))): ((uint32_t)((deviceaddress) + ((uint16_t)0x0555))))))) = ((uint16_t)0x0010)); __DSB(); } while(0)
                                          ;
      }
    }
    else
...
# 1240 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_Read_CFI(NOR_HandleTypeDef *hnor, NOR_CFITypeDef *pNOR_CFI)
{
  uint32_t deviceaddress;
  HAL_NOR_StateTypeDef state;
...
# 1427 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_StatusTypeDef HAL_NOR_WriteOperation_Enable(NOR_HandleTypeDef *hnor)
{
...
# 1514 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_NOR_StateTypeDef HAL_NOR_GetState(const NOR_HandleTypeDef *hnor)
{
  return hnor->State;
}
# 1528 "D:/RTOS/Board/YD-STM32H7xxVx_ClassicV19/cmake-build-debug/_deps/stm32h7xx_hal_driver-src/Src/stm32h7xx_hal_nor.c"
HAL_NOR_StatusTypeDef HAL_NOR_GetStatus(NOR_HandleTypeDef *hnor, uint32_t Address, uint32_t Timeout)
{
  ...
  else if (hnor->CommandSet == (uint16_t)0x0001)
  {
    do
    {
      do{ (*(volatile uint16_t *)((uint32_t)(Address)) = ((uint16_t)0x0070)); __DSB(); } while(0);
      tmpsr2 = *(volatile uint16_t *)(Address);
    ...
    } while ((tmpsr2 & (uint16_t)0x0080) == 0U);

    do{ (*(volatile uint16_t *)((uint32_t)(Address)) = ((uint16_t)0x0070)); __DSB(); } while(0);
    tmpsr1 = *(volatile uint16_t *)(Address);
    if ((tmpsr1 & ((uint16_t)0x0020 | (uint16_t)0x0010)) != 0U)
    {
