...
{
    os_thread_init(&task1, "Task1", thread_entry, 0, task1_stack, sizeof(task1_stack), 20, 50);
    os_thread_startup(&task1);

    os_thread_init(&task2, "Task2", thread_entry, 0, task2_stack, sizeof(task2_stack), 20, 50);
