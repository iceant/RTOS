...
#define USARTx_IRQHandler           UART3_IRQHandler

#define TxDMAx_CLOCK                RCU_DMA0
#define TxDMAx                      DMA0
#define TxDMAx_CHn                  DMA_CH4
#define TxDMA_SUBPERI               DMA_SUBPERI4
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////
static BSP_RS4852_RxHandler BSP_RS4852__RxHandler = 0;
static void* BSP_RS4852__RxHandlerUserdata = 0;
...
{
	BSP_RS4852__RxHandler = rxHandler;
	BSP_RS4852__RxHandlerUserdata = userdata;
}
...
void USARTx_IRQHandler(void)
{
        ...
        (RESET != usart_flag_get(USARTx, USART_FLAG_RBNE))) 
    {
        ...
        if(BSP_RS4852__RxHandler){
            BSP_RS4852__RxHandler(ch, BSP_RS4852__RxHandlerUserdata);
        }
    }
