...
#define USART_CLOCK 				RCU_USART5

#define USART_TX_GPIO_CLOCK         RCU_GPIOC
#define USART_TX_GPIOX 			    GPIOC
#define USART_TX_ALF_NUM 		    GPIO_AF_8
#define USART_TX_PIN 				GPIO_PIN_6

#define USART_RX_GPIO_CLOCK         RCU_GPIOC
#define USART_RX_GPIOX 			    GPIOC
#define USART_RX_ALF_NUM 		    GPIO_AF_8
#define USART_RX_PIN 				GPIO_PIN_7

#define RS485_DE_GPIO_CLOCK         RCU_GPIOA
#define RS485_DE_GPIOX 			    GPIOA
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////
static BSP_RS4853_RxHandler BSP_RS4853__RxHandler = 0;
static void* BSP_RS4853__RxHandlerUserdata = 0;
...
{
	BSP_RS4853__RxHandler = rxHandler;
	BSP_RS4853__RxHandlerUserdata = userdata;
}
...
void USARTx_IRQHandler(void)
{
        ...
        (RESET != usart_flag_get(USARTx, USART_FLAG_RBNE))) 
    {
        ...
        if(BSP_RS4853__RxHandler){
            BSP_RS4853__RxHandler(ch, BSP_RS4853__RxHandlerUserdata);
        }
    }
