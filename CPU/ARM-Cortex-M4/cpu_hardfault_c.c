...
//    }
    ...
    bus_fault_address = REG_SCB_BFAR;
    memmanage_fault_address = REG_SCB_MMFAR;
    cfsr = REG_SCB_CFSR;
    ...
    printf("HFSR = 0x%08lx ", REG_SCB_HFSR); show_hfsr(REG_SCB_HFSR);
    printf("DFSR = 0x%08lx ", REG_SCB_DFSR); show_dfsr(REG_SCB_DFSR);
    printf("AFSR = 0x%08lx\n", REG_SCB_AFSR);
